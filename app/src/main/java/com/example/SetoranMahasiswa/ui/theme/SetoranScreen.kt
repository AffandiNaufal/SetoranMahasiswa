...
import com.example.SetoranMahasiswa.DataModels
...
fun SetoranItemCard(setoran: DataModels.SetoranItem) {
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = androidx.compose.ui.graphics.Color(0xFFC8E6C9)
        )
    ) {
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Spacer(modifier = Modifier.height(4.dp))
            Text(
                text = if (setoran.sudahSetor) "Sudah Disetor" else "Belum Disetor",
